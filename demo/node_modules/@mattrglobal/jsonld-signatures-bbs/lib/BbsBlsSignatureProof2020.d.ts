...
import { DeriveProofOptions, DidDocumentPublicKey, VerifyProofOptions, CreateVerifyDataOptions, CanonizeOptions } from "./types";
...
export declare class BbsBlsSignatureProof2020 extends suites.LinkedDataProof {
     ...
     */
    getVerificationMethod({ proof, documentLoader }: any): Promise<DidDocumentPublicKey>;
