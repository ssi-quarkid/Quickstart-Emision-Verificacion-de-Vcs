...
function extractPublicKeyHex(pk, convert = false) {
    ...
    if (convert) {
        if (['Ed25519', 'Ed25519VerificationKey2018', 'Ed25519VerificationKey2020'].includes(pk.type) || (pk.type === 'JsonWebKey2020' && ((_a = pk.publicKeyJwk) === null || _a === void 0 ? void 0 : _a.crv) === 'Ed25519')) {
            keyBytes = (0, ed25519_1.convertPublicKeyToX25519)(keyBytes);
        }
        else if (!['X25519', 'X25519KeyAgreementKey2019', 'X25519KeyAgreementKey2020'].includes(pk.type) && !(pk.type === 'JsonWebKey2020' && ((_b = pk.publicKeyJwk) === null || _b === void 0 ? void 0 : _b.crv) === 'X25519')) {
            return '';
        }
    }
