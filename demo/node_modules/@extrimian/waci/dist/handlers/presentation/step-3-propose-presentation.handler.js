...
var ProposePresentationHandler = /** @class */ (function () {
    ...
    ProposePresentationHandler.prototype.handle = function (messageThread) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, callbacks_1.callbacks[types_1.Actor.Verifier].getPresentationDefinition({ invitationId: invitationId })];
                    case 1:
