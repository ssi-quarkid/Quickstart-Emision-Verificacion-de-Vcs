 ...
 */
class BbsBlsSignature2020 extends jsonld_signatures_1.suites.LinkedDataProof {
    /**
     * Default constructor
    ...
    async createProof(options) {
        ...
        if (this.proof) {
            ...
            proof = await jsonld_1.default.compact(this.proof, jsonld_signatures_1.SECURITY_CONTEXT_URL, {
                documentLoader,
                expansionMap,
            ...
            proof = { "@context": jsonld_signatures_1.SECURITY_CONTEXT_URL };
        }
    ...
    async verifySignature(options) {
        ...
        return await verifier.verify({
            data: verifyData,
            signature: new Uint8Array(Buffer.from(proof[this.proofSignatureKey], "base64")),
        });
    }
}
