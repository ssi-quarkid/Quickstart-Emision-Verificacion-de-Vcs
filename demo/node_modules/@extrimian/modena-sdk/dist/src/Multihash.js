...
class Multihash {
    ...
    static hashAsNonMultihashBuffer(content, hashAlgorithmInMultihashCode) {
        ...
        switch (hashAlgorithmInMultihashCode) {
            case 18: // SHA256
                ...
                break;
            default:
                throw new ModenaError_1.default(ErrorCode_1.default.MultihashUnsupportedHashAlgorithm, `Hash algorithm defined in multihash code ${hashAlgorithmInMultihashCode} is not supported.`);
        }
        return hash;
    }
    /**
    ...
    static validateEncodedHashComputedUsingSupportedHashAlgorithm(encodedMultihash, inputContextForErrorLogging) {
        ...
        try {
            ...
            throw new ModenaError_1.default(ErrorCode_1.default.MultihashStringNotAMultihash, `Given ${inputContextForErrorLogging} string '${encodedMultihash}' is not a multihash after decoding.`);
        }
        ...
        if (hashAlgorithmInMultihashCode !== multihash.code) {
            throw new ModenaError_1.default(ErrorCode_1.default.MultihashUnsupportedHashAlgorithm, `Given ${inputContextForErrorLogging} uses unsupported multihash algorithm with code ${multihash.code}, ` +
