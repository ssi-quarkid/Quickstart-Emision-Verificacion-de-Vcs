...
<head>
    <title>Code coverage report for src/Encoder.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> Encoder.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { b64fromBuffer, b64fromURLSafe, b64toURLSafe } from '@waiting/base64';
...
&nbsp;
  ...
  public static decodeAsBuffer (encodedContent: string, inputContextForErrorLogging: string): Buffer {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!Encoder.isBase64UrlString(encodedContent)) {
<span class="cstat-no" title="statement not covered" >      throw new ModenaError(ErrorCode.EncodedStringIncorrectEncoding, `Given ${inputContextForErrorLogging} must be base64url string.`);</span>
    }
