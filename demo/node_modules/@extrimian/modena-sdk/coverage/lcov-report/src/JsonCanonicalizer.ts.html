...
<head>
    <title>Code coverage report for src/JsonCanonicalizer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> JsonCanonicalizer.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const canonicalize = require('canonicalize');
&nbsp;
/**
...
&nbsp;
  ...
  private static removeAllUndefinedProperties (content: any): any {
    for (const key in content) {
      ...
      } else <span class="missing-if-branch" title="if path not taken" >I</span>if (content[key] === undefined) {
<span class="cstat-no" title="statement not covered" >        delete content[key];</span>
      }
    }
&nbsp;
    return content;
