...
<head>
    <title>Code coverage report for src/ModenaDid.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> ModenaDid.ts</h1>
        <div class='clearfix'>
...
&nbsp;
    ...
    let shortFormDid;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (ModenaSdkConfig.network === undefined || ModenaSdkConfig.network === 'mainnet') {
<span class="cstat-no" title="statement not covered" >      shortFormDid = `did:${didUniqueSuffix}`;</span>
    } else {
