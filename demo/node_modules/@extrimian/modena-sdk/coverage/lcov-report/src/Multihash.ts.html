...
<head>
    <title>Code coverage report for src/Multihash.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../index.html">All files</a> / <a href="index.html">src</a> Multihash.ts</h1>
        <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >        throw new ModenaError(</span>
...
<span class="cstat-no" title="statement not covered" >      multihash = multihashes.decode(multihashBuffer);</span>
    } catch {
<span class="cstat-no" title="statement not covered" >      throw new ModenaError(</span>
...
&nbsp;
    const hashAlgorithmInMultihashCode = <span class="cstat-no" title="statement not covered" >ModenaSdkConfig.hashAlgorithmInMultihashCode;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    <span class="missing-if-branch" title="if path not taken" >I</span>if (hashAlgorithmInMultihashCode !== multihash.code) {</span>
<span class="cstat-no" title="statement not covered" >      throw new ModenaError(</span>
        ErrorCode.MultihashUnsupportedHashAlgorithm,
