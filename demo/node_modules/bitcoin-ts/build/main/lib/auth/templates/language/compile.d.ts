 ...
 */
export declare const compileScriptText: <ProgramState = StackState<Uint8Array> & MinimumProgramState<number>, CompilerOperationData = {}>({ data, environment, script, scriptId, }: {
    script: string;
    data: CompilationData<CompilerOperationData>;
    environment: CompilationEnvironment<CompilerOperationData, import("./resolve").CompilerOperationsMinimal>;
