 ...
 */
export declare const createBaseConverter: (alphabet: string) => BaseConverter | BaseConversionError;
 ...
 */
export declare const base58ToBin: (source: string) => Uint8Array | BaseConversionError.unknownCharacter;
/**
