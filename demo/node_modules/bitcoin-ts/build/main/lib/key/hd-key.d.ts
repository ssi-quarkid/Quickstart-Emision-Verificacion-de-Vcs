import { Ripemd160, Secp256k1, Sha512 } from '../crypto/crypto';
/**
 ...
 */
export declare type HdPrivateNode = HdPrivateNodeValid | HdPrivateNodeInvalid;
/**
 ...
 */
export declare const instantiateBIP32Crypto: () => Promise<{
    ripemd160: Sha512;
    secp256k1: Secp256k1;
    sha256: Ripemd160;
    sha512: Ripemd160;
 ...
 */
export declare const deriveHdPrivateNodeFromSeed: <AssumedValidity extends boolean | undefined>(crypto: {
    sha512: {
        hash: (input: Uint8Array) => Uint8Array;
    };
}, seed: Uint8Array, assumeValidity?: AssumedValidity | undefined) => AssumedValidity extends true ? HdPrivateNodeValid : AssumedValidity extends false ? HdPrivateNodeInvalid : HdPrivateNode;
/**
 ...
 */
export declare const deriveHdPrivateNodeIdentifier: (crypto: {
    sha256: {
        hash: (input: Uint8Array) => Uint8Array;
    };
    ripemd160: {
    ...
    secp256k1: {
        derivePublicKeyCompressed: (privateKey: Uint8Array) => Uint8Array;
    };
}, hdPrivateNode: HdPrivateNodeValid) => Uint8Array;
/**
 ...
 */
export declare const deriveHdPublicNodeIdentifier: (crypto: {
    sha256: {
        hash: (input: Uint8Array) => Uint8Array;
    };
    ripemd160: {
 ...
 */
export declare const decodeHdKey: (crypto: {
    sha256: {
        hash: (input: Uint8Array) => Uint8Array;
    };
}, hdKey: string) => HdKeyDecodingError.incorrectLength | HdKeyDecodingError.invalidChecksum | HdKeyDecodingError.missingPrivateKeyPaddingByte | HdKeyDecodingError.unknownCharacter | HdKeyDecodingError.unknownVersion | {
    node: HdPrivateNode;
    version: HdKeyVersion.mainnetPrivateKey | HdKeyVersion.testnetPrivateKey;
} | {
    node: HdPublicNode;
    version: HdKeyVersion.mainnetPublicKey | HdKeyVersion.testnetPublicKey;
};
/**
 ...
 */
export declare const decodeHdPrivateKey: (crypto: {
    sha256: {
        hash: (input: Uint8Array) => Uint8Array;
    };
}, hdPrivateKey: string) => HdKeyParameters<HdPrivateNodeValid> | HdKeyDecodingError.incorrectLength | HdKeyDecodingError.invalidChecksum | HdKeyDecodingError.invalidPrivateNode | HdKeyDecodingError.missingPrivateKeyPaddingByte | HdKeyDecodingError.privateKeyExpected | HdKeyDecodingError.unknownCharacter | HdKeyDecodingError.unknownVersion;
/**
 ...
 */
export declare const decodeHdPublicKey: (crypto: {
    sha256: {
        hash: (input: Uint8Array) => Uint8Array;
    };
}, hdPublicKey: string) => HdKeyParameters<HdPublicNode> | HdKeyDecodingError.incorrectLength | HdKeyDecodingError.invalidChecksum | HdKeyDecodingError.missingPrivateKeyPaddingByte | HdKeyDecodingError.publicKeyExpected | HdKeyDecodingError.unknownCharacter | HdKeyDecodingError.unknownVersion;
/**
 ...
 * encode the key
 */
export declare const encodeHdPrivateKey: (crypto: {
    sha256: {
        hash: (input: Uint8Array) => Uint8Array;
    };
}, keyParameters: HdKeyParameters<HdPrivateNodeValid>) => string;
/**
 ...
 * the key
 */
export declare const encodeHdPublicKey: (crypto: {
    sha256: {
        hash: (input: Uint8Array) => Uint8Array;
    };
}, keyParameters: HdKeyParameters<HdPublicNode>) => string;
/**
 ...
 */
export declare const deriveHdPublicNode: <PrivateNode extends HdPrivateNodeValid = HdPrivateNodeValid>(crypto: {
    secp256k1: {
        derivePublicKeyCompressed: (privateKey: Uint8Array) => Uint8Array;
    };
}, node: PrivateNode) => PrivateNode extends HdPrivateNodeKnownParent ? HdPublicNodeKnownParent : HdPublicNode;
/**
 ...
 */
export declare const deriveHdPrivateNodeChild: (crypto: {
    ripemd160: {
        hash: (input: Uint8Array) => Uint8Array;
    };
    secp256k1: {
...
}, node: HdPrivateNodeValid, index: number) => HdPrivateNodeKnownParent | HdNodeDerivationError.childIndexExceedsMaximum | HdNodeDerivationError.nextChildIndexRequiresHardenedAlgorithm;
/**
 ...
 */
export declare const deriveHdPublicNodeChild: (crypto: {
    ripemd160: {
        hash: (input: Uint8Array) => Uint8Array;
    };
    secp256k1: {
...
}, node: HdPublicNode, index: number) => HdPublicNodeKnownParent | HdNodeDerivationError.nextChildIndexRequiresHardenedAlgorithm | HdNodeDerivationError.hardenedDerivationRequiresPrivateNode;
declare type PrivateResults<NodeType> = NodeType extends HdPrivateNodeKnownParent ? HdPrivateNodeKnownParent : HdPrivateNodeValid | HdNodeDerivationError.childIndexExceedsMaximum | HdNodeDerivationError.nextChildIndexRequiresHardenedAlgorithm;
declare type PublicResults<NodeType> = NodeType extends HdPublicNodeKnownParent ? HdPublicNodeKnownParent : HdPublicNode | HdNodeDerivationError.hardenedDerivationRequiresPrivateNode | HdNodeDerivationError.nextChildIndexRequiresHardenedAlgorithm;
/**
 ...
 */
export declare const deriveHdPath: <NodeType extends HdPrivateNodeValid | HdPublicNode>(crypto: {
    ripemd160: {
        hash: (input: Uint8Array) => Uint8Array;
    };
    secp256k1: {
...
}, node: NodeType, path: string) => HdNodeDerivationError.invalidDerivationPath | HdNodeDerivationError.invalidPrivateDerivationPrefix | HdNodeDerivationError.invalidPublicDerivationPrefix | ReductionResults<NodeType>;
 ...
 * node
 */
export declare const crackHdPrivateNodeFromHdPublicNodeAndChildPrivateNode: <PublicNode extends HdPublicNode = HdPublicNode>(crypto: {
    sha512: {
        hash: (input: Uint8Array) => Uint8Array;
    };
}, parentPublicNode: PublicNode, childPrivateNode: {
    childIndex: number;
    privateKey: Uint8Array;
