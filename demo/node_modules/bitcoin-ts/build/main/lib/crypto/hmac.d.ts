 ...
 */
export declare const instantiateHmacFunction: (hashFunction: (input: Uint8Array) => Uint8Array, blockByteLength: number) => (secret: Uint8Array, message: Uint8Array) => Uint8Array;
/**
 ...
 */
export declare const hmacSha256: (sha256: {
 ...
 * @param message - the message to authenticate
 */
export declare const hmacSha512: (sha512: {
    hash: (input: Uint8Array) => Uint8Array;
}, secret: Uint8Array, message: Uint8Array) => Uint8Array;
