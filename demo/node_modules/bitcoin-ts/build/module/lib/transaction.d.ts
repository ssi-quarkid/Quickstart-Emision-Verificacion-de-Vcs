 ...
 */
export declare const serializeInput: (input: Input<Uint8Array, Uint8Array>) => Uint8Array;
/**
 ...
 */
export declare const serializeInputs: (inputs: readonly Input<Uint8Array, Uint8Array>[]) => Uint8Array;
/**
 ...
 */
export declare const serializeOutput: (output: Output<Uint8Array, number>) => Uint8Array;
/**
 ...
 */
export declare const serializeOutputsForTransaction: (outputs: readonly Output<Uint8Array, number>[]) => Uint8Array;
/**
 ...
 */
export declare const deserializeTransaction: (bin: Uint8Array) => Transaction<Input<Uint8Array, Uint8Array>, Output<Uint8Array, number>>;
/**
 * TODO: doc
 */
export declare const serializeTransaction: (tx: Transaction<Input<Uint8Array, Uint8Array>, Output<Uint8Array, number>>) => Uint8Array;
/**
 ...
 */
export declare const getBitcoinIdentifier: (data: Uint8Array, sha256: {
 ...
 * @param sha256 - an implementation of sha256
 */
export declare const getBitcoinTransactionId: (transaction: Uint8Array, sha256: {
    hash: (input: Uint8Array) => Uint8Array;
}) => string;
/**
 ...
 * @param sha256 - an implementation of sha256
 */
export declare const serializeOutpoints: (inputs: readonly {
    outpointIndex: number;
    outpointTransactionHash: Uint8Array;
}[]) => Uint8Array;
/**
 ...
 */
export declare const serializeOutputsForSigning: (outputs: readonly Output<Uint8Array, number>[]) => Uint8Array;
/**
 * Serialize a series of input sequence numbers.
 *
 * @param inputs - the series of inputs from which to extract the sequence numbers
 */
export declare const serializeSequenceNumbers: (inputs: readonly {
    sequenceNumber: number;
}[]) => Uint8Array;
