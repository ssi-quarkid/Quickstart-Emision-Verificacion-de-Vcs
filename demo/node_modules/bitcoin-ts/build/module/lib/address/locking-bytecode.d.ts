 ...
 */
export declare const cashAddressToLockingBytecode: (address: string) => import("./bech32").BitRegroupingError | import("./cash-address").CashAddressDecodingError | LockingBytecodeEncodingError.unknownCashAddressType | {
    bytecode: Uint8Array;
    prefix: string;
};
/**
