 ...
 */
export declare const encodeCashAddressVersionByte: (type: CashAddressAvailableTypes, bitLength: 256 | 192 | 224 | 160 | 320 | 384 | 448 | 512) => number;
 ...
 */
export declare const encodeCashAddressFormat: <Prefix extends string = CashAddressNetworkPrefix, Version extends number = CashAddressVersionByte>(prefix: Prefix, version: Version, hash: Readonly<ArrayLike<number>> & Iterable<number> & {
 ...
 */
export declare const decodeCashAddressFormatWithoutPrefix: (address: string, possiblePrefixes?: readonly string[]) => import("./bech32").BitRegroupingError | CashAddressDecodingError.invalidFormat | CashAddressDecodingError.malformedPayload | CashAddressDecodingError.invalidChecksum | {
    hash: Uint8Array;
    prefix: string;
    version: number;
};
