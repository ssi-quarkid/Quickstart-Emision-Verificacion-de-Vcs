 ...
 */
export declare type WalletImportFormatType = 'mainnet' | 'testnet' | 'mainnet-uncompressed' | 'testnet-uncompressed';
/**
 ...
 * `testnet`)
 */
export declare const encodePrivateKeyWif: (sha256: {
    hash: (input: Uint8Array) => Uint8Array;
}, privateKey: Uint8Array, type: WalletImportFormatType) => string;
/**
 ...
 */
export declare const decodePrivateKeyWif: (sha256: {
    hash: (input: Uint8Array) => Uint8Array;
}, wifKey: string) => import("../address/base58-address").Base58AddressError.unknownCharacter | import("../address/base58-address").Base58AddressError.tooShort | import("../address/base58-address").Base58AddressError.invalidChecksum | {
