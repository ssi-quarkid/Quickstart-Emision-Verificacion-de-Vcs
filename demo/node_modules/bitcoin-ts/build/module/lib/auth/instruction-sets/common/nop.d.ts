 ...
 */
export declare const disabledOperation: <State extends ErrorState<Errors, AuthenticationErrorCommon>, Errors>() => (state: State) => State;
export declare const disabledOperations: <State extends ErrorState<Errors, AuthenticationErrorCommon>, Errors>() => {
